...
//security to prevent re-entrancy attacks
...
contract NFTMarket is ReentrancyGuard {
    ...
    uint256 listingPrice = 0.025 ether; //cost of listing nfts in your marketplace
    ...
    function createMarketItem(
        ...
        uint256 price) public payable nonReentrant {
            ...
            //transfer nft ownership to the contract itself
        ...
        function createMarketSale(
            ...
            //transfer nft ownership from the contract to the buyer
        ...
        function fetchMyNFTs() public view returns (MarketItem[] memory) {
            ...
            for(uint i =0; i < totalItemCount; i++) {
                //get only the items that this user has bought or is owner
